...
gulp.task('js-lib', function () {
  gulp.src(['./src/lib/jquery-2.1.1.min.js', './src/lib/materialize.js', './src/lib/requestToast.js', './src/lib/init.js', './src/lib/request.js', './src/lib/micromarkdown.js', './src/lib/taptic.js'])
  .pipe(uglify())
  .pipe(concat('lib.js'))
  .pipe(gulp.dest('./dist'))
  .pipe(connect.reload());
